#
# This is a PowerShell script that builds a .NET project and compresses the output into an archive.
#
...
try {
      ...
      Write-Host "Archive now available here: '$OutputPath/$OutputFilename'"
} catch {
